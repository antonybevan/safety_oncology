/******************************************************************************
 * Bundle:  t004_t_eff_orr
 * Source:  m5/datasets/bv-car20-p1/analysis/adam/programs/reporting/t_eff.sas
 *
 * Table 2.1 - Objective Response Rate (ORR) by dose level with Clopper-Pearson
 * exact 95% CI. The analytic body below is the repo's t_eff.sas unchanged; the
 * ADAM library (adrs, adsl) is supplied as a small in-memory mock by the
 * bundle autoexec so the PROC FREQ / betainv / PROC REPORT logic runs in
 * isolation.
 ******************************************************************************/
