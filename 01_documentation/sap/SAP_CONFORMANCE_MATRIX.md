...
| **Treatment Mapping** (§5.3) | `TRT01P` / `TRT01A` | Verified |
...
|:---|:---|:---:|
| **TEAE Onset** (§8.2.1) | `ASTDT >= LDSTDT` (Lymphodepletion Start) | Compliant |
| **TEAE_CELL** | `ASTDT >= CARTDT` (CAR-T Specific) | Hardened |
| **CRS/ICANS Grading** | ASTCT Consensus Grading prioritized | Compliant |
| **ASTCT Traceability** | `ADAE.ASTCTGR` retained | Hardened |
| **AESI Duration** | `ADAE`: Duration = (Resolution - Onset + 1) | Compliant |
| **ICANS Resolution** | 72-hour resolving DLT logic implemented | Compliant |

## 3. Reporting & TFL Logic
| Requirement | Output ID | Compliance Status |
|:---|:---|:---:|
| **Subject Disposition** | Table 1.1 (`t_dm.sas`) | Compliant |
| **ORR (RE Pop)** | Table 2.1 (`t_eff.sas`) | Compliant |
| **AESI Summary** | Table 3.4 (`t_ae_aesi.sas`) | Compliant |
| **Grade 3/4 Labs** | Table 3.6 (`t_lb_grad.sas`) | Compliant |
| **Decimal Precision** | Mean/SD: x+1; Min/Max/Med: x | Compliant |
